...
export const localClient: DataClient = {
  ...
  permitCategories: makeRepo("permit_categories"),
  permitDocumentTypes: makeRepo("permit_document_types"),
  permitChecklistTemplates: makeRepo("permit_checklist_templates"),
  permitChecklistTemplateItems: makeRepo("permit_checklist_template_items"),
  permitCases: makeRepo("permit_cases"),
  permitCaseItems: makeRepo("permit_case_items"),
  permitDocuments: makeRepo("permit_documents"),
  permitDocumentEmployees: makeRepo("permit_document_employees"),
  permitCaseItemDocuments: makeRepo("permit_case_item_documents"),
