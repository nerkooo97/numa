...
export const appwriteClient: DataClient = {
  ...
  permitCategories: makeAppwriteRepo(COLLECTIONS.permitCategories),
  permitDocumentTypes: makeAppwriteRepo(COLLECTIONS.permitDocumentTypes),
  permitChecklistTemplates: makeAppwriteRepo(COLLECTIONS.permitChecklistTemplates),
  permitChecklistTemplateItems: makeAppwriteRepo(COLLECTIONS.permitChecklistTemplateItems),
  permitCases: makeAppwriteRepo(COLLECTIONS.permitCases),
  permitCaseItems: makeAppwriteRepo(COLLECTIONS.permitCaseItems),
  permitDocuments: makeAppwriteRepo(COLLECTIONS.permitDocuments),
  permitDocumentEmployees: makeAppwriteRepo(COLLECTIONS.permitDocumentEmployees),
  permitCaseItemDocuments: makeAppwriteRepo(COLLECTIONS.permitCaseItemDocuments),
